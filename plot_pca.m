...
%    [~, hobj, ~, ~] = legend({filesArray{k}(1:end-4)},'Fontsize',12,'Location','Northwest');
    ...
    title("mean of dwt");
    grid on
   path = "C:\Users\varun ch\Desktop\HASITHA\academix\ASU\DM\American-Sign-Language\output\images\"+"pca_dwt";
    %filename = "dwt"+filesArray{k}(1:end-4)
% 	
  %      hold on
